<div style="max-width: 800px; margin: 40px auto; padding: 30px; background-color: #f0f9f5; border-radius: 15px; box-shadow: 0 8px 20px rgba(0,0,0,0.12); font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: #333; display: flex; align-items: center; gap: 15px;">

  <!-- Left side container: image + gif side by side -->
  <div style="display: flex; flex-shrink: 0; align-items: center; gap: 10px;">
    ...
    <img src="https://raw.githubusercontent.com/R041T/R041T/main/fullstack.gif" alt="coding animation" width="500" style="border-radius: 50%; box-shadow: 0 0 15px rgba(76,175,80,0.7);" />
  </div>
